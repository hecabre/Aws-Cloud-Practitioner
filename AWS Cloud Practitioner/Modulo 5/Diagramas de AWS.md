...
4. **Subredes:** son fragmentos de la VPC que permiten dividirla en secciones más pequeñas y fáciles de administrar. Una subred es, básicamente, un rango de direcciones IP dentro de la VPC.
...
Se utilizan para recursos que necesitan acceso directo a Internet. Su tabla de enrutamiento incluye una ruta hacia una puerta de enlace de Internet; además, los recursos necesitan una dirección IP pública o IPv6 y reglas de seguridad adecuadas. En los diagramas se representan como cuadros de líneas discontinuas.
