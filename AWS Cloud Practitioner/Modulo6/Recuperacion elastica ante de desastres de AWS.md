...
- Después de resolver el incidente, ayuda a sincronizar los datos para realizar la conmutación por recuperación (*failback*) hacia el entorno principal.

> [!important]
> AWS DRS lanza las instancias de recuperación y ayuda a preparar el *failback*, pero la redirección del tráfico entre los entornos es una operación de red externa al servicio.
